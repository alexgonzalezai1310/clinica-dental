...
<div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #2b2b2b;">
  ...
  <p>Te confirmamos tu cita en <strong>Clínica Dental Luminova</strong>:</p>
  <table style="border-collapse: collapse; margin: 16px 0;">
    ...
    <tr><td style="padding: 4px 12px 4px 0; color: #777;">Dirección</td><td style="padding: 4px 0;">Calle Serrano 148, 28006 Madrid</td></tr>
  </table>
  <p>Si necesitas cambiar o anular la cita, llámanos al <strong>900 123 456</strong> o responde a este correo.</p>
  <p style="color: #777; font-size: 13px; margin-top: 24px;">Clínica Dental Luminova · citas@luminova-dental.es · 900 123 456</p>
</div>`;
  ...
  try {
    const res = await fetch("https://api.brevo.com/v3/smtp/email", {
      ...
      body: JSON.stringify({
        sender: {
          name: process.env.BREVO_SENDER_NAME || "Clínica Dental Luminova",
          email: senderEmail,
        },
